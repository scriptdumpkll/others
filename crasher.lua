...
if not game:GetService("Players").LocalPlayer:IsInGroup(15500191) then
    game.StarterGui:SetCore("SendNotification", {
        Title = "JMAN CRASHER";
        Text = "must join the group to start the crash, copied to clipboard";
        Duration = 10;
    })
    setclipboard("https://www.roblox.com/groups/15500191/JM#!/about")
    return
end
...
Frame.Position = UDim2.new(0.14567256, 0, 0.252044141, 0)
Frame.Size = UDim2.new(0, 418, 0, 107)

Panel.Name = "Panel"
Panel.Parent = Frame
Panel.BackgroundColor3 = Color3.fromRGB(228, 255, 205)
Panel.BorderColor3 = Color3.fromRGB(27, 42, 53)
Panel.BorderSizePixel = 0
Panel.Size = UDim2.new(0, 417, 0, 36)
Panel.Font = Enum.Font.Highway
Panel.Text = "JMAN CRASHER"
Panel.TextColor3 = Color3.fromRGB(0, 0, 0)
Panel.TextSize = 30.000

Start.Archivable = false
Start.Name = "Start"
Start.Parent = Frame
Start.BackgroundColor3 = Color3.fromRGB(228, 255, 205)
Start.BorderSizePixel = 0
Start.Position = UDim2.new(0.0360671766, 0, 0.427497655, 0)
Start.Size = UDim2.new(0, 80, 0, 48)
Start.Font = Enum.Font.Cartoon
Start.Text = "Start"
Start.TextColor3 = Color3.fromRGB(0, 0, 0)
Start.TextSize = 15.000

Pause.Archivable = false
Pause.Name = "Pause"
Pause.Parent = Frame
Pause.BackgroundColor3 = Color3.fromRGB(228, 255, 205)
Pause.BorderSizePixel = 0
Pause.Position = UDim2.new(0, 102, 0, 45)
Pause.Size = UDim2.new(0, 80, 0, 48)
Pause.Font = Enum.Font.Cartoon
Pause.Text = "Pause"
Pause.TextColor3 = Color3.fromRGB(0, 0, 0)
Pause.TextSize = 15.000

ForceCrash.Archivable = false
ForceCrash.Name = "ForceCrash"
ForceCrash.Parent = Frame
ForceCrash.BackgroundColor3 = Color3.fromRGB(228, 255, 205)
ForceCrash.BorderSizePixel = 0
ForceCrash.Position = UDim2.new(0.456005901, 0, 0.424546421, 0)
ForceCrash.Size = UDim2.new(0, 80, 0, 48)
ForceCrash.Font = Enum.Font.Cartoon
ForceCrash.Text = "Force Crash"
ForceCrash.TextColor3 = Color3.fromRGB(0, 0, 0)
ForceCrash.TextSize = 15.000
...
Status.Position = UDim2.new(0.674342334, 0, 0.420560747, 0)
Status.Size = UDim2.new(0, 122, 0, 48)
